                ...
                <div class="text-center">
                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <p class="lead">
                                Nous vous proposons des services complets et sur mesure pour répondre à tous vos besoins.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4">
                            <a href="#." class="service-link">
                                <div class="box text-center">
                                    ...
                                    <p>Créez un site web unique et performant qui répond à vos besoins spécifiques.</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-4">
